...
export const loadConfig = (environment = process.env) => {
  ...
  const values = {
    ...
    redisUrl: clean(environment.UPSTASH_REDIS_REST_URL),
    redisToken: clean(environment.UPSTASH_REDIS_REST_TOKEN),
  ...
  const requiredValues = {
    ...
    UPSTASH_REDIS_REST_URL: values.redisUrl,
    UPSTASH_REDIS_REST_TOKEN: values.redisToken,
